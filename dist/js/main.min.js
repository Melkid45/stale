...
$(".sign__body-form-em").on("click", function (e) {
  ...
  $(".burger__black").on("click", function (e) {
    $(".header__black").toggleClass("active"), $(this).toggleClass("active");
  }),
  $(".burger__white").on("click", function (e) {
    $(".header__white").toggleClass("active"), $(this).toggleClass("active");
  }),
